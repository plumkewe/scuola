...
void in_ordine_alfabetico (string[], int[], int[], int);
void in_ordine_eta (string[], int[], int);
...
int main() {
	...
	in_ordine_alfabetico(nomi, alfabeto, anni, 3);
	cout << "\vIn ordine alfabetico: \n";
	stampa(nomi, 3);
	
	
	in_ordine_eta(nomi, anni, 3);
...
void in_ordine_alfabetico (string nomi[3], int alfabeto[3], int anni[3], int lunghezza) {
...
void in_ordine_eta (string nomi[3], int anni[3], int lunghezza) {
